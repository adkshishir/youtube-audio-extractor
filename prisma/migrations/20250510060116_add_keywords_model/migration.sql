...
CREATE TABLE `SEO` (
    ...
    UNIQUE INDEX `SEO_blogId_key`(`blogId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Keyword` (
    ...
    UNIQUE INDEX `Keyword_value_seoId_key`(`value`, `seoId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `SEO` ADD CONSTRAINT `SEO_blogId_fkey` FOREIGN KEY (`blogId`) REFERENCES `Blog`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Keyword` ADD CONSTRAINT `Keyword_seoId_fkey` FOREIGN KEY (`seoId`) REFERENCES `SEO`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
